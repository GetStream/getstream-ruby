...
RSpec.describe 'Chat Moderation Integration', type: :integration do
  ...
  describe 'BanUnbanUser' do
    ...
    it 'bans a user from a channel, verifies, and unbans' do
      ...
      expect(banned_user_ids).to include(@user_2)
      ...
      bans_2 = resp_2.bans || []
      banned_ids_after = bans_2.map do |b|
      ...
      expect(banned_ids_after).not_to include(@user_2)
    ...
    it 'bans a user app-wide, verifies, and unbans' do
      ...
      payload = JSON.generate({ filter_conditions: { 'user_id' => { '$eq' => @user_3 } } })
      resp = @client.make_request(
        :get,
        '/api/v2/chat/query_banned_users',
        query_params: { 'payload' => payload },
      ...
      bans_2 = resp_2.bans || []
      expect(bans_2.length).to eq(0), 'App-wide ban should be removed after unban'
  ...
  describe 'MuteUnmuteUser' do
    ...
    it 'mutes a user, verifies via query, and unmutes' do
      ...
      expect(muted_ids).to include(@user_4)
      ...
      q_resp_2 = @client.common.query_users(JSON.generate({
                                                            filter_conditions: { 'id' => { '$eq' => @user_1 } },
                                                          }))
      user_h_2 = q_resp_2.users[0].is_a?(Hash) ? q_resp_2.users[0] : q_resp_2.users[0].to_h
      mutes_after = user_h_2['mutes'] || []
      ...
      expect(muted_ids_after).not_to include(@user_4)
  ...
  describe 'FlagMessageAndUser' do
    ...
    it 'flags a message and verifies response' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1, @user_2])
      msg_id = send_test_message('messaging', channel_id, @user_1, "Flaggable message #{SecureRandom.hex(4)}")
