...
RSpec.describe 'Chat Message Integration', type: :integration do
  ...
  describe 'SendAndGetMessage' do
    ...
    it 'sends message, gets by ID, verifies text' do
      ...
      send_resp = send_msg('messaging', channel_id,
                           message: { text: msg_text, user_id: @user_1 })
  ...
  describe 'GetManyMessages' do
    ...
    it 'sends 3 messages, gets all 3 by IDs' do
      ...
      id_1 = send_test_message('messaging', channel_id, @user_1, 'Msg 1')
      id_2 = send_test_message('messaging', channel_id, @user_1, 'Msg 2')
      id_3 = send_test_message('messaging', channel_id, @user_1, 'Msg 3')

      resp = get_many_messages('messaging', channel_id, [id_1, id_2, id_3])
  ...
  describe 'UpdateMessage' do
    ...
    it 'sends message, updates text, verifies' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'Original text')

      updated_text = "Updated text #{SecureRandom.hex(8)}"
      resp = update_message(msg_id, message: { text: updated_text, user_id: @user_1 })
  ...
  describe 'PartialUpdateMessage' do
    ...
    it 'sets custom fields; unsets one' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'Partial update test')
      ...
      # Unset custom field
      resp_2 = update_message_partial(msg_id,
                                      unset: ['status'],
                                      user_id: @user_1)
      expect(resp_2.message).not_to be_nil
  ...
  describe 'DeleteMessage' do
    ...
    it 'soft deletes, verifies type=deleted' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'Message to delete')
  ...
  describe 'HardDeleteMessage' do
    ...
    it 'hard deletes, verifies type=deleted' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'Message to hard delete')
  ...
  describe 'PinUnpinMessage' do
    ...
    it 'sends pinned message; unpins via partial update' do
      ...
      send_resp = send_msg('messaging', channel_id,
                           message: { text: 'Pinned message', user_id: @user_1, pinned: true })
      expect(send_resp.message).not_to be_nil
      msg_id = send_resp.message.id
  ...
  describe 'TranslateMessage' do
    ...
    it 'translates to Spanish, verifies i18n field' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'Hello, how are you?')
  ...
  describe 'ThreadReply' do
    ...
    it 'sends parent, sends reply with parent_id, gets replies' do
      ...
      # Send parent message
      parent_id = send_test_message('messaging', channel_id, @user_1, 'Parent message for thread')

      # Send reply
      reply_resp = send_msg('messaging', channel_id,
                            message: { text: 'Reply to parent', user_id: @user_2, parent_id: parent_id })
  ...
  describe 'SearchMessages' do
    ...
    it 'sends message with unique term, waits, searches, verifies found' do
      ...
      send_test_message('messaging', channel_id, @user_1, "This message contains #{search_term} for testing")
  ...
  describe 'SilentMessage' do
    ...
    it 'sends with silent=true, verifies' do
      ...
      resp = send_msg('messaging', channel_id,
                      message: { text: 'This is a silent message', user_id: @user_1, silent: true })
      expect(resp.message).not_to be_nil
  ...
  describe 'QueryMessageHistory' do
    ...
    it 'sends, updates twice, queries history, verifies entries (skip if not enabled)' do
      ...
      send_resp = send_msg('messaging', channel_id,
                           message: { text: 'initial text', user_id: @user_1,
                                      custom: { 'custom_field' => 'custom value' } })
      msg_id = send_resp.message.id

      # Update by user1
      update_message(msg_id, message: { text: 'updated text', user_id: @user_1,
                                        custom: { 'custom_field' => 'updated custom value' } })

      # Update by user2
      update_message(msg_id, message: { text: 'updated text 2', user_id: @user_2 })
  ...
  describe 'QueryMessageHistorySort' do
    ...
    it 'queries history with ascending sort' do
      ...
      send_resp = send_msg('messaging', channel_id,
                           message: { text: 'sort initial', user_id: @user_1 })
      msg_id = send_resp.message.id

      update_message(msg_id, message: { text: 'sort updated 1', user_id: @user_1 })
      update_message(msg_id, message: { text: 'sort updated 2', user_id: @user_1 })
  ...
  describe 'SkipEnrichUrl' do
    ...
    it 'sends with URL and skip_enrich_url=true, verifies no attachments' do
      ...
      send_resp = send_msg('messaging', channel_id,
                           message: { text: 'Check out https://getstream.io for more info', user_id: @user_1 },
      ...
      attachments_2 = get_resp.message.to_h['attachments'] || []
      expect(attachments_2).to be_empty
  ...
  describe 'KeepChannelHidden' do
    ...
    it 'hides channel, sends with keep_channel_hidden=true, verifies still hidden' do
      ...
      # Hide the channel
      hide_channel('messaging', channel_id, user_id: @user_1)

      # Send a message with keep_channel_hidden=true
      send_msg('messaging', channel_id,
               message: { text: 'Hidden message', user_id: @user_1 },
  ...
  describe 'UndeleteMessage' do
    ...
    it 'soft deletes, undeletes, verifies restored' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'Message to undelete')
  ...
  describe 'RestrictedVisibility' do
    ...
    it 'sends with restricted_visibility list (skip if not enabled)' do
      ...
      expect(send_resp.message.to_h['restricted_visibility']).to eq([@user_1])
  ...
  describe 'DeleteMessageForMe' do
    ...
    it 'deletes message with delete_for_me=true' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1])
      msg_id = send_test_message('messaging', channel_id, @user_1, 'test message to delete for me')

      delete_message(msg_id, { 'delete_for_me' => 'true', 'deleted_by' => @user_1 })
  ...
  describe 'PinExpiration' do
    ...
    it 'pins with 3s expiry, waits 4s, verifies expired' do
      ...
      _type, channel_id, _resp = create_test_channel_with_members(@user_1, [@user_1, @user_2])
      msg_id = send_test_message('messaging', channel_id, @user_2, 'Message to pin with expiry')
  ...
  describe 'SystemMessage' do
    ...
    it 'sends with type=system, verifies' do
      ...
      resp = send_msg('messaging', channel_id,
                      message: { text: 'User joined the channel', user_id: @user_1, type: 'system' })
      expect(resp.message).not_to be_nil
  ...
  describe 'PendingFalse' do
    ...
    it 'sends with pending=false, verifies immediately available' do
      ...
      send_resp = send_msg('messaging', channel_id,
                           message: { text: 'Non-pending message', user_id: @user_1 },
                           pending: false)
      expect(send_resp.message).not_to be_nil
  ...
  describe 'SearchWithMessageFilters' do
    ...
    it 'searches using message_filter_conditions' do
      ...
      send_test_message('messaging', channel_id, @user_1, "This has #{search_term} text")
      send_test_message('messaging', channel_id, @user_1, "This also has #{search_term} text")
