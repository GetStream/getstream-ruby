...
module GetStream
  module Generated
    module Models
      ...
      class MemberRemovedEvent < GetStream::BaseModel
        ...
        # @!attribute _type
        #   @return [String] The type of event: "member.removed" in this case
        attr_accessor :_type
        # @!attribute channel_id
        #   @return [String] The ID of the channel from which the member was removed
        ...
        #   @return [String] The type of the channel from which the member was removed
        attr_accessor :channel_type
        # @!attribute cid
        #   @return [String] The CID of the channel from which the member was removed
        attr_accessor :cid
        ...
        def initialize(attributes = {})
          ...
          @_type = attributes[:_type] || attributes['type'] || "member.removed"
