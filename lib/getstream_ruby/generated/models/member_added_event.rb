...
module GetStream
  module Generated
    module Models
      ...
      class MemberAddedEvent < GetStream::BaseModel
        ...
        #   @return [String] The type of the channel to which the member was added
        attr_accessor :channel_type
        # @!attribute cid
        #   @return [String] The CID of the channel to which the member was added
        attr_accessor :cid
